...
/* Definitions for handleButton */
osThreadId_t handleButtonHandle;
const osThreadAttr_t handleButton_attributes = {
  .name = "handleButton",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_HandleButton */
/**
